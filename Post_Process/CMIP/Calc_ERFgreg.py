...
rlut = pk.load(open(Source+Models+'_Ajd_4xCO2_TmSrs.pi','rb'))['rlut']
rlutcs = pk.load(open(Source+Models+'_Ajd_4xCO2_TmSrs.pi','rb'))['rlutcs']

rsut = pk.load(open(Source+Models+'_Ajd_4xCO2_TmSrs.pi','rb'))['rsut']
...
tas_stk = pk.load(open(Source+Models+'_Ajd_4xCO2_TmSrs.pi','rb'))['tas']
tas_grid = np.mean(tas_stk[140:,:,:,:],axis=(0,1))
tas_season = aa.LatLonavg_Time(np.ma.mean(tas_stk[140:,:,:,:],axis=0),lat,lon)
