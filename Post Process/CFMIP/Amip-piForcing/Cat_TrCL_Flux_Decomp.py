...
Source = '/praid/users/jgvirgin/CanESM_Data/'+model+'/amip/Fluxes/'
...
file_lw = open(model+'_TrCLlw_FLUX_MZdecomp_Grid.pi','wb')
pk.dump(merged_lw,file_lw)
file_lw.close()

file_sw = open(model+'_TrCLsw_FLUX_MZdecomp_Grid.pi', 'wb')
