...
# In[3]:
print('read in data')
plnck_stk = pk.load(open(Source+'/amip/Fluxes/'+models+'_PLANCK_FLUX_Grid.pi','rb'))
lpse_stk = pk.load(open(Source+'/amip/Fluxes/'+models+'_LAPSE_FLUX_Grid.pi','rb'))
ta_sr_stk = pk.load(open(Source+'/amip/Fluxes/'+models+'_SrTEMP_FLUX_Grid.pi','rb'))
