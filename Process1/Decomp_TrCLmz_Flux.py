...
Source = '/home/jgvirgin/Projects/CanESM/Data/'+model
...
print('SW - ', aa.LatLonavg_Time(CLsw_fb_AM['Standard']['All'][None,:,:],CanESM_lat,CanESM_lon)[0])
print('LW - ', aa.LatLonavg_Time(CLlw_fb_AM['Standard']['All'][None,:,:],CanESM_lat,CanESM_lon)[0])
