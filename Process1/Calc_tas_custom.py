...
picon_file = glob.glob(Source+'vars_interp_Amon_*')[1]
x4_file = glob.glob(Source+'vars_interp_Amon_*')[0]
...
mask = np.isfinite(data_x4_stk['tas'])

delta = data_x4_stk['tas']-data_picon_stk['tas']
